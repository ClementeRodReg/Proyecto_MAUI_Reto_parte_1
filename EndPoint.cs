...
namespace Proyecto_MAUI_Reto_parte_1
{
    public class EndPoint
    {
        ...
        {
            //var urld = $"https://air-quality-api.open-meteo.com/v1/air-quality?latitude={lat}&longitude={lon}&current=european_aqi&hourly=pm10,pm2_5,carbon_monoxide,ozone,european_aqi&timezone=Europe%2FLondon";
            var url = $"https://air-quality-api.open-meteo.com/v1/air-quality?latitude={lat}&longitude={lon}&current=european_aqi&hourly=pm10,pm2_5,carbon_monoxide,ozone,european_aqi&timezone=Europe%2FLondon";
            return url;
        }
